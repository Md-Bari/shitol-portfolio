...
const helloWords = [
  ...
  { text: "Mirë se vini", lang: "Macedonian" },
  { text: "Selam", lang: "Amharic" },
  { text: "Barev", lang: "Armenian" },
  { text: "Salam", lang: "Azerbaijani" },
  { text: "Gamarjoba", lang: "Georgian" },
  { text: "Salam", lang: "Kazakh" },
  { text: "Салам", lang: "Kyrgyz" },
  { text: "Salom", lang: "Uzbek" },
  { text: "Merhaba", lang: "Turkmen" },
  { text: "ہیلو", lang: "Pashto" },
  { text: "سلام", lang: "Farsi" },
  { text: "Mingalaba", lang: "Burmese" },
  { text: "ສະບາຍດີ", lang: "Lao" },
  { text: "ជំរាបសួរ", lang: "Khmer" },
  { text: "Halo", lang: "Indonesian" },
  { text: "Helo", lang: "Welsh" },
  { text: "Dia dhuit", lang: "Irish" },
  { text: "Halò", lang: "Scottish Gaelic" },
  { text: "Zdravstvuyte", lang: "Mongolian" },
  { text: "Dumela", lang: "Sotho" },
